...
<sub>This Markdown is a faithful text conversion of `trust-infrastructure-for-probabilistic-agents.pdf`, which remains the authoritative source. A few reference URLs were rejoined across PDF line-breaks; if one looks off, check it against the PDF.</sub>
